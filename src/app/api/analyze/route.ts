  ...
  try {
    ...
    const analysis: Analysis = {
      ...
      agents: [
        ...
        { role: 'aerospace', title: 'PhD Aerospace Engineer', emoji: '🚀', content: '', status: 'pending' },
        { role: 'nuclear', title: 'PhD Nuclear Engineer', emoji: '⚛️', content: '', status: 'pending' },
        { role: 'biology', title: 'PhD Biologist', emoji: '🧬', content: '', status: 'pending' },
        { role: 'ai_expert', title: 'PhD AI/ML Scientist', emoji: '🤖', content: '', status: 'pending' },
        { role: 'mechanical', title: 'PhD Mechanical Engineer', emoji: '⚙️', content: '', status: 'pending' },
        { role: 'physics', title: 'PhD Physicist', emoji: '🔬', content: '', status: 'pending' },
        { role: 'legal', title: 'Legal/Regulatory Analyst', emoji: '🧑‍⚖️', content: '', status: 'pending' },
        { role: 'geopolitical', title: 'Geopolitical Analyst', emoji: '🌍', content: '', status: 'pending' },
        { role: 'team', title: 'Founder/Team Assessor', emoji: '🧑‍💼', content: '', status: 'pending' },
        { role: 'supply_chain', title: 'Supply Chain Engineer', emoji: '🔗', content: '', status: 'pending' },
        { role: 'growth', title: 'Growth/GTM Strategist', emoji: '📈', content: '', status: 'pending' },
        { role: 'cybersecurity', title: 'Cybersecurity Analyst', emoji: '🛡️', content: '', status: 'pending' },
        { role: 'fund_fit', title: 'LP/Fund Fit Analyst', emoji: '🏦', content: '', status: 'pending' },
